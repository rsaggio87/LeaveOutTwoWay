...
This readme shows how to compute standard errors for linear regression coefficients that are unbiased even in the presence of serial-correlation of the error term within cluster. This might be particularly useful when estimating a regression model with very few clusters. This [document](https://github.com/rsaggio87/LeaveOutTwoWay/blob/d0bbffb399830710827b775415031ea0350f0c67/doc/metrics.pdf) describes and provides intuition for the econometric formula used in this package and derived in Lemma 3 of [Kline-Saggio-Sølvsten (2020)](https://eml.berkeley.edu/~pkline/papers/KSS2020.pdf).
